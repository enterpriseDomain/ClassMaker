...
import org.enterprisedomain.ecp.*;
...
public class ECPFactoryImpl extends EFactoryImpl implements ECPFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ECPPackage.EOPERATION_INVOCATION: return createEOperationInvocation();
			case ECPPackage.EPARAMETER_TO_OBJECT_MAP_ENTRY: return (EObject)createEParameterToObjectMapEntry();
			default:
