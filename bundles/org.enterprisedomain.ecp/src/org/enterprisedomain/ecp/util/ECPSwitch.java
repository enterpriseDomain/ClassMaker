 ...
 * @generated
 */
public class ECPSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ECPPackage.EPARAMETER_TO_OBJECT_MAP_ENTRY: {
			...
			Map.Entry<EParameter, Object> eParameterToObjectMapEntry = (Map.Entry<EParameter, Object>) theEObject;
	 ...
	 * '<em>EOperation Invocation</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>EOperation Invocation</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>EParameter To Object Map Entry</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>EParameter To Object Map Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEParameterToObjectMapEntry(Map.Entry<EParameter, Object> object) {
		return null;
	}
