...
public class ECPAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ECPSwitch<Adapter> modelSwitch =
		new ECPSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.enterprisedomain.ecp.EOperationInvocation <em>EOperation Invocation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>EParameter To Object Map Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
