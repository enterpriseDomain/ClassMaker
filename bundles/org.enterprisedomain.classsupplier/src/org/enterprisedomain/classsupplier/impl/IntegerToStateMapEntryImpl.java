 ...
 * </p>
 * <ul>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.IntegerToStateMapEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.IntegerToStateMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerToStateMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<Integer, State> {
	...
	protected EClass eStaticClass() {
		return ClassSupplierPackage.Literals.INTEGER_TO_STATE_MAP_ENTRY;
	}
	...
	public void setTypedKey(Integer newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__KEY,
					oldKey, key));
	}
	...
	public NotificationChain basicSetTypedValue(State newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__VALUE, newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__KEY:
			return getTypedKey();
		case ClassSupplierPackage.INTEGER_TO_STATE_MAP_ENTRY__VALUE:
