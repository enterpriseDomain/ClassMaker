 ...
 * Maker</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.ClassSupplierImpl#getWorkspace <em>Workspace</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassSupplierImpl extends EObjectImpl implements ClassSupplier {
			...
			if (workspace != oldWorkspace) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ClassSupplierPackage.CLASS_SUPPLIER__WORKSPACE, oldWorkspace, workspace));
			}
		}
		return workspace;
	}
	...
	public void setWorkspace(Workspace newWorkspace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassSupplierPackage.CLASS_SUPPLIER__WORKSPACE,
	 ...
	 * @generated NOT
	 */
	public EPackage create(EPackage dynamicModel) throws CoreException {
		IProgressMonitor monitor = ClassSupplierOSGi.getInstance().getProgressMonitor();
		return create(dynamicModel, monitor);
	}
	 ...
	 * @generated NOT
	 */
	public EPackage create(EPackage dynamicModel, IProgressMonitor monitor) throws CoreException {
		try {
	 ...
	 * @generated NOT
	 */
	public EPackage update(EPackage queryModel, EPackage dynamicModel) throws CoreException {
		return update(queryModel, dynamicModel, false);
	}
	 ...
	 * @generated NOT
	 */
	public EPackage update(EPackage queryModel, EPackage dynamicModel, IProgressMonitor monitor) throws CoreException {
		return update(queryModel, dynamicModel, false, monitor);
	}
	 ...
	 * @generated NOT
	 */
	public EPackage update(EPackage queryModel, EPackage dynamicModel, boolean changeVersion) throws CoreException {
		IProgressMonitor monitor = ClassSupplierOSGi.getInstance().getProgressMonitor();
		return update(queryModel, dynamicModel, changeVersion, monitor);
	}
	 ...
	 * @generated NOT
	 */
	public EPackage update(EPackage queryModel, EPackage dynamicModel, boolean changeVersion, IProgressMonitor monitor)
