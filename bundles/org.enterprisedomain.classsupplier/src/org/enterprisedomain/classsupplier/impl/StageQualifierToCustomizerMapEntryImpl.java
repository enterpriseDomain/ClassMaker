 ...
 * </p>
 * <ul>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.StageQualifierToCustomizerMapEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.StageQualifierToCustomizerMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StageQualifierToCustomizerMapEntryImpl extends EObjectImpl
	...
	protected EClass eStaticClass() {
		return ClassSupplierPackage.Literals.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY;
	}
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ClassSupplierPackage.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY__KEY, oldKey, key));
			}
		}
		return key;
	}
	...
	public NotificationChain basicSetTypedValue(Customizer newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ClassSupplierPackage.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY__VALUE,
						null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY__VALUE, newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ClassSupplierPackage.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ClassSupplierPackage.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY__KEY:
			if (resolve)
				return getTypedKey();
