...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Version To Revision Map Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.VersionToRevisionMapEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.enterprisedomain.classsupplier.impl.VersionToRevisionMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionToRevisionMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<Version, Revision> {
	...
	protected EClass eStaticClass() {
		return ClassSupplierPackage.Literals.VERSION_TO_REVISION_MAP_ENTRY;
	}
	...
	public void setTypedKey(Version newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.VERSION_TO_REVISION_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public NotificationChain basicSetTypedValue(Revision newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.VERSION_TO_REVISION_MAP_ENTRY__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ClassSupplierPackage.VERSION_TO_REVISION_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ClassSupplierPackage.VERSION_TO_REVISION_MAP_ENTRY__VALUE, newValue, newValue));
	}
