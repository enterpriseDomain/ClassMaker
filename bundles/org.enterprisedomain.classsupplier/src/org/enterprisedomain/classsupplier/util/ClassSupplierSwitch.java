...
public class ClassSupplierSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ClassSupplierPackage.ITEM: {
		...
		case ClassSupplierPackage.EMAP: {
		...
		case ClassSupplierPackage.RESOURCE_SET: {
		...
		case ClassSupplierPackage.RESOURCE: {
		...
		case ClassSupplierPackage.COMPLETION_LISTENER: {
