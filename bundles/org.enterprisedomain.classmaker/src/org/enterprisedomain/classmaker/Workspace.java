...
public interface Workspace extends EObject, ISchedulingRule {
	 ...
	 * list. The list contents are of type {@link org.enterprisedomain.classmaker.Project}. It
	 * is bidirectional and its opposite is '
	 * {@link org.enterprisedomain.classmaker.Project#getWorkspace <em>Workspace</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
