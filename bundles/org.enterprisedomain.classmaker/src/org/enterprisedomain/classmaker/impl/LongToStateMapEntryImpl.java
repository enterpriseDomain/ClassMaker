...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Long To
 * State Map Entry</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class LongToStateMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<Long, State> {
	/**
	...
	protected EClass eStaticClass() {
		return ClassMakerPackage.Literals.LONG_TO_STATE_MAP_ENTRY;
	}
	...
	public void setTypedKey(Long newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassMakerPackage.LONG_TO_STATE_MAP_ENTRY__KEY,
					oldKey, key));
	}
	...
	public NotificationChain basicSetTypedValue(State newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ClassMakerPackage.LONG_TO_STATE_MAP_ENTRY__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ClassMakerPackage.LONG_TO_STATE_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ClassMakerPackage.LONG_TO_STATE_MAP_ENTRY__VALUE,
					newValue, newValue));
	}
	...
	public EMap<Long, State> getEMap() {
		EObject container = eContainer();
		return container == null ? null : (EMap<Long, State>) container.eGet(eContainmentFeature());
	}
