...
/**
 * This is the item provider adapter for a {@link org.enterprisedomain.classmaker.imagesUI.Measurement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Measurement_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Measurement_from_feature", "_UI_Measurement_type"),
				 ImagesUIPackage.Literals.MEASUREMENT__FROM,
				 true,
				 false,
				 false,
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Measurement_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Measurement_to_feature", "_UI_Measurement_type"),
				 ImagesUIPackage.Literals.MEASUREMENT__TO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Point labelValue = ((Measurement)object).getFrom();
	...
	public ResourceLocator getResourceLocator() {
		return ImagesUIEditPlugin.INSTANCE;
	}
