		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModelPair_dynamic_feature",
								"_UI_ModelPair_type"),
						ClassMakerPackage.Literals.MODEL_PAIR__DYNAMIC, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModelPair_generated_feature",
								"_UI_ModelPair_type"),
						ClassMakerPackage.Literals.MODEL_PAIR__GENERATED, true, false, true, null, null, null));
	}
