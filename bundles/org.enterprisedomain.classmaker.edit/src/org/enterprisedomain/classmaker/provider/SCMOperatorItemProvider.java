 ...
 * {@link org.enterprisedomain.classmaker.SCMOperator} object. <!--
...
public class SCMOperatorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	/**
	 * This adds a property descriptor for the Registry feature. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addRegistryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SCMOperator_registry_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SCMOperator_registry_feature",
								"_UI_SCMOperator_type"),
						ClassMakerPackage.Literals.SCM_OPERATOR__REGISTRY, true, false, true, null, null, null));
	}
