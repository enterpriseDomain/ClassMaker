...
/**
 * This is the item provider adapter for a {@link org.enterprisedomain.ecp.EOperationInvocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EOperationInvocationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EOperationInvocation_eOperation_feature", "_UI_EOperationInvocation_type"),
				 ECPPackage.Literals.EOPERATION_INVOCATION__EOPERATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addResultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EOperationInvocation_result_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EOperationInvocation_result_feature", "_UI_EOperationInvocation_type"),
				 ECPPackage.Literals.EOPERATION_INVOCATION__RESULT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_EOperationInvocation_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ECPPackage.Literals.EOPERATION_INVOCATION__ARGUMENTS,
