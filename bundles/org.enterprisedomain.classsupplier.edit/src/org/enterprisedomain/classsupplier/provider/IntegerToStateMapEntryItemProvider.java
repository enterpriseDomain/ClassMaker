...
public class IntegerToStateMapEntryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IntegerToStateMapEntry_key_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IntegerToStateMapEntry_key_feature",
								"_UI_IntegerToStateMapEntry_type"),
						ClassSupplierPackage.Literals.INTEGER_TO_STATE_MAP_ENTRY__KEY, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ClassSupplierPackage.Literals.INTEGER_TO_STATE_MAP_ENTRY__VALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.INTEGER_TO_STATE_MAP_ENTRY__VALUE,
