...
/**
 * This is the item provider adapter for a {@link org.enterprisedomain.classsupplier.Revision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RevisionItemProvider extends ItemItemProvider {
	...
	protected void addContributionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Revision_contribution_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Revision_contribution_feature",
								"_UI_Revision_type"),
						ClassSupplierPackage.Literals.REVISION__CONTRIBUTION, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Revision_state_feature",
								"_UI_Revision_type"),
						ClassSupplierPackage.Literals.REVISION__STATE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Revision_timestamp_feature",
								"_UI_Revision_type"),
						ClassSupplierPackage.Literals.REVISION__TIMESTAMP, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Revision_latestTimestamp_feature",
								"_UI_Revision_type"),
						ClassSupplierPackage.Literals.REVISION__LATEST_TIMESTAMP, false, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ClassSupplierPackage.Literals.REVISION__STATE_HISTORY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.REVISION__STATE_HISTORY,
