...
/**
 * This is the item provider adapter for a {@link org.enterprisedomain.classsupplier.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ClassSupplierPackage.Literals.PROJECT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Project_projectName_feature",
								"_UI_Project_type"),
						ClassSupplierPackage.Literals.PROJECT__PROJECT_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Project_children_feature",
								"_UI_Project_type"),
						ClassSupplierPackage.Literals.PROJECT__CHILDREN, false, false, false, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Project_dirty_feature",
								"_UI_Project_type"),
						ClassSupplierPackage.Literals.PROJECT__DIRTY, false, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ClassSupplierPackage.Literals.PROJECT__CHILDREN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createProject()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createContribution()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createRevision()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createState()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createWorkspace()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.create(ClassSupplierPackage.Literals.INTEGER_TO_STATE_MAP_ENTRY)));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.create(ClassSupplierPackage.Literals.VERSION_TO_REVISION_MAP_ENTRY)));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createCustomizer()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createStageQualifier()));

		newChildDescriptors.add(
				createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN, ClassSupplierFactory.eINSTANCE
						.create(ClassSupplierPackage.Literals.STAGE_QUALIFIER_TO_CUSTOMIZER_MAP_ENTRY)));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createModelPair()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createResourceAdapter()));

		newChildDescriptors.add(createChildParameter(ClassSupplierPackage.Literals.PROJECT__CHILDREN,
				ClassSupplierFactory.eINSTANCE.createClassSupplier()));
