...
It generates source code from the provided model, builds, exports, and installs it in runtime as entire plug-in, and then loads classes, that are reflectively accessible through modeled API.  
