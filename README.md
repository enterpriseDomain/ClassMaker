...
To use the library, [download](https://github.com/kirillzotkin/ClasSupplier/releases) and add it to the target platform  satisfying subsequent dependencies (p2 TBD). E4 DI is supported.
