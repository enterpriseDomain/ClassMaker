...
It will be possible to switch from EMF Ecore to your own self-reflective or non-self-reflective meta-model, 
and switch from OSGi as a deployment and loading facility to, for instance, JEE container, also.  
