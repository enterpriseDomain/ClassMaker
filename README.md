...
It generates source code from the model provided, exports binary, installs in runtime, and then loads classes making available for client code's reflective access through modeled API.  
