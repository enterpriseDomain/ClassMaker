...
Here is even more [code](/tests/org.classupplier.tests/src/org/classupplier/tests/TestClassSupplier.java), where you can specify a method body and call it, customize generation templates. 
